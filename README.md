...
## 🚀 Featured Projects
- [llm-finetuning-lora](link): Fine-tuned a 7B model with LoRA on [dataset], achieving [metric].
- [llm-evaluation-suite](link): Benchmark for testing LLM truthfulness/hallucinations.
- [multimodalperception](link): IEEE paper on multi-modal object detection (Bosch Research).

## 🛠️ Skills
!['PyTorch'](https://img.shields.io/badge/PyTorch-EE4C2C?logo=pytorch&logoColor=white)
!['Transformers'](https://img.shields.io/badge/Transformers-FF6B6B?logo=huggingface&logoColor=white)
!['JAX'](https://img.shields.io/badge/JAX-FF6B6B?logo=jax&logoColor=white)
-->
